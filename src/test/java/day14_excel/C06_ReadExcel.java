...
public class C06_ReadExcel {
    ...
    public void readExcelTest() throws IOException {
        ...
        // boylece her seferinde excel' ulasip satir,sutun vs.. ugrasmayalim

        // Database yapisinda olan excel'i
        // koyabilecegimiz en uygun java objesi map'tir
        ...
        for (int i = 0; i <= sonSatirIndex; i++) {
            ...
            // value ise i. satirdaki 1,2 ve 3. indexdeki datalarin birlesmesi olacak
